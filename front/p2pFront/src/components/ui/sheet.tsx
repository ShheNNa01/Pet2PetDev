...
import { cn } from "../../lib/utils"; // Asegúrate de que cn esté bien definido
...
// Eliminamos `className` en `SheetPortal` ya que no es necesario aquí
...
// Variantes para el contenido del Sheet
...
// Props para el contenido del Sheet
